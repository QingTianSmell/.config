...
cmodal:bind('', 'escape', 'Deactivate GoApp', function() spoon.ModalMgr:deactivate({"GoApp"}) end)
...
if spoon.KSheet then
	...
	spoon.ModalMgr.supervisor:bind({"alt"}, "/", "Enter KeySheet Environment", function()
		spoon.KSheet:show()
		spoon.ModalMgr:deactivateAll()
